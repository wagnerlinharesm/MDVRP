...
public class LocalSearchUniqueRoute {
	...
	public static void localSearch(Container_Deposits dep) throws CloneNotSupportedException {
		...
		/*
		 * 1. Mover um cliente u e realocá-lo após outro cliente v; 
		 * 2. Mover os clientes u e x para depois do cliente v, nessa ordem; 3. Mover os clientes u e x para depois do cliente v, em ordem inversa;
		 * 4. Trocar as posições dos clientes u e v; Estrategia 1
		 * 5. Trocar as posições dos clientes u e x pela de v;
		 * 6. Trocar as posições dos clientes u e x pelas de v e y; 
		 * 7. Se u e v pertencem a mesma rota, trocar os arcos (u, x) e (v, y) por (u, v) e (x, y); 
		 * 8. Se u e v pertencem a rotas distintas; trocar os arcos (u, x) e (v, y) por (u, v) e (x, y); 
		 * 9. Se u e v pertencem a rotas distintas; trocar os arcos (u, x) e (v, y)  por (u, y) e (x, v).
		 */
...
//		 ArrayList<Integer> strategy = new ArrayList<>(Arrays.asList(1, 2, 3, 4, 5, 6, 7, 8, 9)); // 2 --,5,6
	...
	public static Container_Deposits swapUV(Container_Deposits novo, int rndDep1, int rndVec1, int rndDep2, int rndVec2) {
		// anterior = null;
		anterior = novo.clone();
				...
				for (v = 0; v < novo.Deposit_List.get(rndDep2).vehicles.Vehicles_List.get(rndVec2).clients.Client_List
					...
					if (u == v && rndDep1 == rndDep2 && rndVec1 == rndVec2) {
						...
						if (novo.Deposit_List.get(rndDep2).vehicles.Vehicles_List
							...
							if (novo.fullcoast < anterior.fullcoast && EvolutionEstrategy.calcularNovoCusto(novo)) {
								//
								// attemp = tentativas;
	...
	public static Container_Deposits realocarUV(Container_Deposits novo, int rndDep1, int rndVec1, int rndDep2, int rndVec2) {
	...
	public static Container_Deposits UXaposV(Container_Deposits novo, int rndDep1, int rndVec1, int rndDep2, int rndVec2) {
		anterior = null;
		attemp = 0;
	...
	public static Container_Deposits XUaposV(Container_Deposits novo, int rndDep1, int rndVec1, int rndDep2, int rndVec2) {
		anterior = null;
		attemp = 0;
	...
	public static Container_Deposits swapUXtoV(Container_Deposits novo, int rndDep1, int rndVec1, int rndDep2, int rndVec2) {
		anterior = novo.clone();
...
//System.out.println(novo.Deposit_List.get(rndVec2).vehicles.Vehicles_List.get(rndVec2).clients.Client_List.size());
	...
	public static Container_Deposits swapUXtoVY(Container_Deposits novo, int rndDep1, int rndVec1, int rndDep2, int rndVec2) {
		anterior = null;
	...
	public static Container_Deposits trocarArcosUXtoVY(Container_Deposits novo, int rndDep1, int rndVec1) {
	...
	public static Container_Deposits trocarUXeVYporUVeXY(Container_Deposits novo, int rndDep1, int rndVec1, int rndDep2, int rndVec2) {
		anterior = null;
		attemp = 0;
	...
	public static Container_Deposits trocarUXeVYporUYeXV(Container_Deposits novo, int rndDep1, int rndVec1, int rndDep2, int rndVec2) {
		anterior = null;
		attemp = 0;
		//// System.out.println(attemp);
		int demandU = 0, demandV = 0;
