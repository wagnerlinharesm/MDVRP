...
public class LocalSearchBestImprovement implements Runnable {
	public Container_Deposits anterior;
	public Random rnd = new Random();
	public Container_Deposits melhor;
	public Container_Deposits dep;

	public LocalSearchBestImprovement(Container_Deposits dep) {
		this.dep = dep.clone();
	}
	...
	public Container_Deposits swapUV(Container_Deposits novo) {
		// anterior = null;
		...
		if (novo.Deposit_List.get(rndDep2).vehicles.Vehicles_List.get(rndVec2).clients.Client_List.size() >= 1
				&& novo.Deposit_List.get(rndDep1).vehicles.Vehicles_List.get(rndVec1).clients.Client_List.size() >= 1) {
	...
	public Container_Deposits realocarUV(Container_Deposits novo) {
		melhor = novo.clone();
		anterior = novo.clone();
		...
		rndVec2 = rnd.nextInt(novo.Deposit_List.get(rndDep2).vehicles.Vehicles_List.size());
						if (novo.Deposit_List.get(rndDep2).vehicles.Vehicles_List.get(rndVec2).clients.Client_List
								.size() >= 1
								&& novo.Deposit_List.get(rndDep1).vehicles.Vehicles_List
										.get(rndVec1).clients.Client_List.size() >= 1) {

							for (u = 0; u < novo.Deposit_List.get(rndDep1).vehicles.Vehicles_List
									.get(rndVec1).clients.Client_List.size(); u++) {
								for (v = 0; v < novo.Deposit_List.get(rndDep2).vehicles.Vehicles_List
									...
									if (!(u == v && rndDep1 == rndDep2 && rndVec1 == rndVec2)) {
										...
										novo.Deposit_List.get(rndDep2).vehicles.Vehicles_List
												.get(rndVec2).vehicleDemand = novo.Deposit_List
														.get(rndDep2).vehicles.Vehicles_List.get(rndVec2).vehicleDemand
														+ novo.Deposit_List.get(rndDep1).vehicles.Vehicles_List
																.get(rndVec1).clients.Client_List.get(u).demand;

										novo.Deposit_List.get(rndDep1).vehicles.Vehicles_List
												.get(rndVec1).vehicleDemand = novo.Deposit_List
														.get(rndDep1).vehicles.Vehicles_List.get(rndVec1).vehicleDemand
														- novo.Deposit_List.get(rndDep1).vehicles.Vehicles_List
																.get(rndVec1).clients.Client_List.get(u).demand;

										if (novo.Deposit_List.get(rndDep2).vehicles.Vehicles_List.get(
												rndVec2).vehicleDemand <= novo.Deposit_List.get(rndDep2).VehicleLoad
												&& novo.Deposit_List.get(rndDep1).vehicles.Vehicles_List
														.get(rndVec1).vehicleDemand <= novo.Deposit_List
																.get(rndDep1).VehicleLoad
												&& novo.Deposit_List.get(rndDep1).vehicles.Vehicles_List
											...
											int posV = novo.Deposit_List.get(rndDep2).vehicles.Vehicles_List
													.get(rndVec2).clients.Client_List.indexOf(
															novo.Deposit_List.get(rndDep2).vehicles.Vehicles_List
																	.get(rndVec2).clients.Client_List.get(v));

											novo.Deposit_List.get(rndDep2).vehicles.Vehicles_List
													.get(rndVec2).clients.Client_List.add(posV + 1, aux.clone());
											novo.Deposit_List.get(rndDep1).vehicles.Vehicles_List
	...
	public Container_Deposits UXaposV(Container_Deposits novo) {
		anterior = novo.clone();
		...
		rndVec2 = rnd.nextInt(novo.Deposit_List.get(rndDep2).vehicles.Vehicles_List.size());
						if (novo.Deposit_List.get(rndDep2).vehicles.Vehicles_List.get(rndVec2).clients.Client_List
								.size() >= 1
								&& novo.Deposit_List.get(rndDep1).vehicles.Vehicles_List
										.get(rndVec1).clients.Client_List.size() >= 2) {
							...
							for (u = 0; u < novo.Deposit_List.get(rndDep1).vehicles.Vehicles_List
								...
								for (v = 0; v < novo.Deposit_List.get(rndDep2).vehicles.Vehicles_List
									...
									if (!((u == v || x == v) && rndDep1 == rndDep2 && rndVec1 == rndVec2)) {
										...
										novo.Deposit_List.get(rndDep2).vehicles.Vehicles_List
												.get(rndVec2).vehicleDemand += novo.Deposit_List
														.get(rndDep1).vehicles.Vehicles_List
																.get(rndVec1).clients.Client_List.get(u).demand
														+ novo.Deposit_List.get(rndDep1).vehicles.Vehicles_List
										...
										if (novo.Deposit_List.get(rndDep2).vehicles.Vehicles_List.get(
											...
											novo.Deposit_List.get(rndDep2).vehicles.Vehicles_List
													.get(rndVec2).clients.Client_List.add(posV + 1, aux.clone());
											novo.Deposit_List.get(rndDep2).vehicles.Vehicles_List
													.get(rndVec2).clients.Client_List.add(posV + 2, aux2.clone());
											// Remover U e X
											novo.Deposit_List.get(rndDep1).vehicles.Vehicles_List
													.get(rndVec1).clients.Client_List.remove(aux);
											novo.Deposit_List.get(rndDep1).vehicles.Vehicles_List
	...
	public Container_Deposits XUaposV(Container_Deposits novo) {
		anterior = novo.clone();
		...
		for (rndDep1 = 0; rndDep1 < novo.Deposit_List.size(); rndDep1++) {
			for (rndDep2 = 0; rndDep2 < novo.Deposit_List.size(); rndDep2++) {
				for (rndVec1 = 0; rndVec1 < novo.Deposit_List.get(rndDep1).vehicles.Vehicles_List.size(); rndVec1++) {
					for (rndVec2 = 0; rndVec2 < novo.Deposit_List.get(rndDep2).vehicles.Vehicles_List
							.size(); rndVec2++) {
						if (novo.Deposit_List.get(rndDep2).vehicles.Vehicles_List.get(rndVec2).clients.Client_List
								.size() >= 1
								&& novo.Deposit_List.get(rndDep1).vehicles.Vehicles_List
	...
	public Container_Deposits swapUXtoV(Container_Deposits novo) {
		anterior = novo.clone();
		melhor = novo.clone();
									...
									if (!((u == v || x == v) && rndDep1 == rndDep2 && rndVec1 == rndVec2)) {
										...
										if (novo.Deposit_List.get(rndDep2).vehicles.Vehicles_List.get(
											...
											int posU = novo.Deposit_List.get(rndDep1).vehicles.Vehicles_List
													.get(rndVec1).clients.Client_List.indexOf(
															novo.Deposit_List.get(rndDep1).vehicles.Vehicles_List
																	.get(rndVec1).clients.Client_List.get(u));

											novo.Deposit_List.get(rndDep2).vehicles.Vehicles_List
													.get(rndVec2).clients.Client_List.add(posV, aux2.clone());
											novo.Deposit_List.get(rndDep2).vehicles.Vehicles_List
													.get(rndVec2).clients.Client_List.add(posV + 1, aux.clone());
											novo.Deposit_List.get(rndDep1).vehicles.Vehicles_List
													.get(rndVec1).clients.Client_List.add(posU, aux3.clone());
											...
											novo.Deposit_List.get(rndDep1).vehicles.Vehicles_List
													.get(rndVec1).clients.Client_List.remove(aux2);
											novo.Deposit_List.get(rndDep2).vehicles.Vehicles_List
													.get(rndVec2).clients.Client_List.remove(aux3);
	...
	public Container_Deposits swapUXtoVY(Container_Deposits novo) {
		anterior = novo.clone();
		melhor = novo.clone();
		...
		rndVec2 = rnd.nextInt(novo.Deposit_List.get(rndDep2).vehicles.Vehicles_List.size());
						...
						for (u = 0; u < novo.Deposit_List.get(rndDep1).vehicles.Vehicles_List
							...
							for (v = 0; v < novo.Deposit_List.get(rndDep2).vehicles.Vehicles_List
								...
								y = v + 1;
								// int demand3, demand1;
								if (!(((u == v || x == v) || (u == y || x == y)) && rndDep1 == rndDep2
										&& rndVec1 == rndVec2)) {
									...
									if (novo.Deposit_List.get(rndDep2).vehicles.Vehicles_List
										...
										novo.Deposit_List.get(rndDep1).vehicles.Vehicles_List
												.get(rndVec1).clients.Client_List.add(posU, aux3.clone());
										novo.Deposit_List.get(rndDep1).vehicles.Vehicles_List
												.get(rndVec1).clients.Client_List.add(posU + 1, aux4.clone());
										...
										novo.Deposit_List.get(rndDep2).vehicles.Vehicles_List
												.get(rndVec2).clients.Client_List.remove(aux3);
										novo.Deposit_List.get(rndDep2).vehicles.Vehicles_List
												.get(rndVec2).clients.Client_List.remove(aux4);
	...
	public Container_Deposits trocarArcosUXtoVY(Container_Deposits novo) {
		...
		rndVec1 = rnd.nextInt(novo.Deposit_List.get(rndDep1).vehicles.Vehicles_List.size());
				...
				if (novo.Deposit_List.get(rndDep1).vehicles.Vehicles_List.get(rndVec1).clients.Client_List
						.size() >= 4) {

					for (int u = 0; u < novo.Deposit_List.get(rndDep1).vehicles.Vehicles_List
							.get(rndVec1).clients.Client_List.size() - 3; u++) {
						int x = u + 1;
						// //System.out.println("U : " + u);
						for (int v = x + 1; v < novo.Deposit_List.get(rndDep1).vehicles.Vehicles_List
								.get(rndVec1).clients.Client_List.size() - 1; v++) {
							int y = v + 1;

							Collections.reverse(novo.Deposit_List.get(rndDep1).vehicles.Vehicles_List
									.get(rndVec1).clients.Client_List.subList(x, y));
							Distribution.funcaoObjetivo(anterior);
							Distribution.funcaoObjetivo(novo);
	...
	public Container_Deposits trocarUXeVYporUVeXY(Container_Deposits novo) {
		...
		rndVec2 = rnd.nextInt(novo.Deposit_List.get(rndDep2).vehicles.Vehicles_List.size());
						...
						if (novo.Deposit_List.get(rndDep2).vehicles.Vehicles_List.get(rndVec2).clients.Client_List
								.size() >= 4
								&& novo.Deposit_List.get(rndDep1).vehicles.Vehicles_List
										.get(rndVec1).clients.Client_List.size() >= 4
							...
							for (int u = 0; u < novo.Deposit_List.get(rndDep1).vehicles.Vehicles_List
								...
								for (int v = 0; v < novo.Deposit_List.get(rndDep2).vehicles.Vehicles_List
									...
									for (int i = 0; i <= u; i++) {
										novoU.Client_List.add(novo.Deposit_List.get(rndDep1).vehicles.Vehicles_List
												.get(rndVec1).clients.Client_List.get(i).clone());

									}

									for (int i = v; i >= 0; i--) {
										novoU.Client_List.add(novo.Deposit_List.get(rndDep2).vehicles.Vehicles_List
												.get(rndVec2).clients.Client_List.get(i).clone());
									}

									for (int i = novo.Deposit_List.get(rndDep1).vehicles.Vehicles_List
											.get(rndVec1).clients.Client_List.size() - 1; i >= x; i--) {
										novoV.Client_List.add(novo.Deposit_List.get(rndDep1).vehicles.Vehicles_List
												.get(rndVec1).clients.Client_List.get(i).clone());
									}

									for (int i = y; i < novo.Deposit_List.get(rndDep2).vehicles.Vehicles_List
											.get(rndVec2).clients.Client_List.size(); i++) {
										novoV.Client_List.add(novo.Deposit_List.get(rndDep2).vehicles.Vehicles_List
												.get(rndVec2).clients.Client_List.get(i).clone());
									}
									...
									if (demandU <= novo.Deposit_List.get(rndDep1).VehicleLoad
										...
										// anterior = novo.clone();
										novo.Deposit_List.get(rndDep1).vehicles.Vehicles_List
												.get(rndVec1).clients.Client_List.clear();
										novo.Deposit_List.get(rndDep1).vehicles.Vehicles_List
												.get(rndVec1).vehicleDemand = 0;

										novo.Deposit_List.get(rndDep2).vehicles.Vehicles_List
												.get(rndVec2).clients.Client_List.clear();
										novo.Deposit_List.get(rndDep2).vehicles.Vehicles_List
												.get(rndVec2).vehicleDemand = 0;
										...
										for (int i = 0; i < novo.Deposit_List.get(rndDep2).vehicles.Vehicles_List
											...
											novo.Deposit_List.get(rndDep2).vehicles.Vehicles_List
													.get(rndVec2).vehicleDemand += novo.Deposit_List
															.get(rndDep2).vehicles.Vehicles_List
	...
	public Container_Deposits trocarUXeVYporUYeXV(Container_Deposits novo) {
		...
		rndVec2 = rnd.nextInt(novo.Deposit_List.get(rndDep2).vehicles.Vehicles_List.size());
						...
						if (novo.Deposit_List.get(rndDep2).vehicles.Vehicles_List.get(rndVec2).clients.Client_List
							...
							for (int u = 0; u < novo.Deposit_List.get(rndDep1).vehicles.Vehicles_List
								...
								for (int v = u + 1; v < novo.Deposit_List.get(rndDep2).vehicles.Vehicles_List
										.get(rndVec2).clients.Client_List.size() - 1; v++) {
									int y = v + 1;
									// //System.out.println("u " + u + " v " + v);
									novoU.Client_List.clear();
